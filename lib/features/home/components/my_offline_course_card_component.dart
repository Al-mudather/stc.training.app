...
class MyOfflineCourseCardComponent extends StatelessWidget {
  MyOfflineCourseCardComponent({
    super.key,
    required this.course,
    this.width = 170,
  });
  final OfflineCourseModel course;
  final double width;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        Get.toNamed(
          Routehelper.GoToOfflineClassRoomPage(
