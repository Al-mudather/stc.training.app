...
import 'package:stc_training/features/class_room/offline/components/offline_chapter_item_content_comp.dart';
...
class OfflineChapterExpandableCard extends StatefulWidget {
  const OfflineChapterExpandableCard({
    super.key,
  ...
  final OfflineUnitModel? unit;

  @override
  State<OfflineChapterExpandableCard> createState() =>
      _OfflineChapterExpandableCardState();
}

class _OfflineChapterExpandableCardState
    extends State<OfflineChapterExpandableCard> {
      ...
      child: Card(
        ...
        child: ExpansionTile(
          ...
          children: List.generate(
            videos?.length ?? 0,
            (index) => OfflineChapterItemContentComp(video: videos?[index]),
          ),
